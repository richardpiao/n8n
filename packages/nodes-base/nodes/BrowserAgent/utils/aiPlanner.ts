...
function buildUserMessage(
	...
	// Add vision context if available (AI visual analysis of screenshot)
	if (pageContext.visionContext) {
		message += 'VISION ANALYSIS (what AI sees on screenshot):\n';
		message += pageContext.visionContext.substring(0, 2000);
		message += '\n\n';
	}
